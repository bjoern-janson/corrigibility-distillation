...
Frozen scientific artifacts are append-only. Mutable summaries may reflect later state but may not strengthen or rewrite frozen claims.

## Corpus Distillation — CLOSED

```text
canonical corpus                         14 repositories
Phase 1 inventory                        COMPLETE
Phase 2 directional substitutability     0 / 182 YES or PARTIAL
...
The null remains a pre-composition semantic/interface typing failure.

## RIL-001 — CLOSED / POSITIVE
...
Earned claim: one bounded existence witness for representation-induced computational leverage.

## RIL-002 — CLOSED / FAMILY-WIDE LEVERAGE

```text
family members                 24
P_i                            PASS 24/24
dynamic A_fixed equality       PASS 24/24
